      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-2">
          ...
          <div className="bg-white rounded-lg shadow-lg p-4 transform hover:scale-105 transition duration-300 ease-in-out">
            ...
            <h3 className='text-xs mt-1 mb-2 italic'>Head of Development (Co-Founder)</h3>
            <p className="text-gray-700 mt-2 md:text-sm text-xs">
          ...
          <div className="bg-white rounded-lg shadow-lg p-4 transform hover:scale-105 transition duration-300 ease-in-out">
            ...
            <h2 className="text-lg md:text-2xl font-semibold mt-4 text-black">Abdullah Khan</h2>
            <h3 className='text-xs mt-1 mb-2 italic'>Head of Editing (Co-Founder)</h3>
            <p className="text-gray-700 mt-2 md:text-sm text-xs">
              Abdullah is a professional video editor with 9+ years of experience editing engaging social media content for high-level clients such as Zaid El-Omar, Launch Good, and Riyadh Muslim.
            </p>
          </div>
        </div>
      </div>
