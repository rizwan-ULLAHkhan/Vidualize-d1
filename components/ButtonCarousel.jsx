...
const BVideoCarousel = ({ videoURLs,tittle }) => {
  ...
  return (
    <div className="lg:hidden bg-black pt-10 " data-carousel="static">
      ...
      <div className="relative">
        ...
        <div className="absolute left-0  top-1/2 transform -translate-y-1/2 cursor-pointer md:ml-44 bg-cyan md:bg-transparent bg-opacity-25 rounded-lg" onClick={goToPreviousImage}>
          <button
            type="button"
        ...
        <div className="absolute right-0 top-1/2 transform -translate-y-1/2 cursor-pointer md:mr-44 bg-cyan md:bg-transparent bg-opacity-25  lg:bg-opacity-100  rounded-lg" onClick={goToNextImage}>
          <button
            type="button"
            className="xs:my-52 my-10"
            data-carousel-next
